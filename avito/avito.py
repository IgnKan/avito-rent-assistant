...
from .schema.messenger.methods import PostWebhook, ChatRead
from .schema.messenger.models import WebhookSubscriptions
from .schema.messenger.methods import SendMessage
from .schema.messenger.models import MessageToSend
...
class Avito:
    ...
    async def send_message(self, send_message: SendMessage):
        call = send_message
        return await self(call)

    async def read_chat(self, chat_read: ChatRead):
        call = chat_read
        return await self(call)